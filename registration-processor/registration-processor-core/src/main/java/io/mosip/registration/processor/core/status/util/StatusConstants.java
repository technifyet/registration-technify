...
public final class StatusConstants {
	...
	public static final String DATA_VERIFICATION_MODULE = RPR_REGISTRATION_PROCESSOR_PREFIX + "DV-";
	public static final String DATA_VERIFICATION_MODULE_SUCCESS = DATA_VERIFICATION_MODULE + SUCCESS;
	public static final String DATA_VERIFICATION_MODULE_FAILED = DATA_VERIFICATION_MODULE + FAILED;
